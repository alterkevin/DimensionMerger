...
for na in lista:
    ...
    if cadenaEMP != "":
        file=open(str(f"{kspathdestino}\\{fecha_carpeta_ayer}\EMP_{fecha_archivo_ayer}_EMP.csv"),"a+")
        file.write(cadenaEMP)
        file.close()
    if cadenaEMPSHFT != "":
        file=open(str(f"{kspathdestino}\\{fecha_carpeta_ayer}\EMP_{fecha_archivo_ayer}_EMPSHFT.csv"),"a+")
        file.write(cadenaEMPSHFT)
        file.close()
    if cadenaEMPSVC != "":
        file=open(str(f"{kspathdestino}\\{fecha_carpeta_ayer}\EMP_{fecha_archivo_ayer}_EMPSVC.csv"),"a+")
        file.write(cadenaEMPSVC)
        file.close()
    if cadenaEMPDSC != "":
        file=open(str(f"{kspathdestino}\\{fecha_carpeta_ayer}\EMP_{fecha_archivo_ayer}_EMPDSC.csv"),"a+")
        file.write(cadenaEMPDSC)
        file.close()
    if cadenaEMPTM != "":
        file=open(str(f"{kspathdestino}\\{fecha_carpeta_ayer}\EMP_{fecha_archivo_ayer}_EMPTM.csv"),"a+")
        file.write(cadenaEMPTM)
        file.close()
    if cadenaEMPSLS != "":
        file=open(str(f"{kspathdestino}\\{fecha_carpeta_ayer}\EMP_{fecha_archivo_ayer}_EMPSLS.csv"),"a+")
        file.write(cadenaEMPSLS)
        file.close()
    if cadenaEMPOTSLS != "":
        file=open(str(f"{kspathdestino}\\{fecha_carpeta_ayer}\EMP_{fecha_archivo_ayer}_EMPOTSLS.csv"),"a+")
        file.write(cadenaEMPOTSLS)
        file.close()

    if cadenaFPSUM != "":
        file=open(f"{kspathdestino}\\{fecha_carpeta_ayer}\FP_{fecha_archivo_ayer}_FPSUM.csv","a+")
        file.write(cadenaFPSUM)
        file.close()
    if cadenaFPOT != "":
        file=open(f"{kspathdestino}\\{fecha_carpeta_ayer}\FP_{fecha_archivo_ayer}_PFOT.csv","a+")
        file.write(cadenaFPOT)
        file.close()
    if cadenaFPMI != "":
        file=open(f"{kspathdestino}\\{fecha_carpeta_ayer}\FP_{fecha_archivo_ayer}_FPMI.csv","a+")
        file.write(cadenaFPMI)
        file.close()

    if cadenaSUM != "":
        file=open(f"{kspathdestino}\\{fecha_carpeta_ayer}\GL_{fecha_archivo_ayer}_SUM.csv","a+")
        file.write(cadenaSUM)
        file.close()
    if cadenaDSC != "":
        file=open(f"{kspathdestino}\\{fecha_carpeta_ayer}\GL_{fecha_archivo_ayer}_DSC.csv","a+")
        file.write(cadenaDSC)
        file.close()
    if cadenaSVC != "":
        file=open(f"{kspathdestino}\\{fecha_carpeta_ayer}\GL_{fecha_archivo_ayer}_SVC.csv","a+")
        file.write(cadenaSVC)
        file.close()
    if cadenaTND != "":
        file=open(f"{kspathdestino}\\{fecha_carpeta_ayer}\GL_{fecha_archivo_ayer}_TND.csv","a+")
        file.write(cadenaTND)
        file.close()
    if cadenaTAX != "":
        file=open(f"{kspathdestino}\\{fecha_carpeta_ayer}\GL_{fecha_archivo_ayer}_TAX.csv","a+")
        file.write(cadenaTAX)
        file.close()
    if cadenaOT != "":
        file=open(f"{kspathdestino}\\{fecha_carpeta_ayer}\GL_{fecha_archivo_ayer}_OT.csv","a+")
        file.write(cadenaOT)
        file.close()
    if cadenaGLC != "":
        file=open(f"{kspathdestino}\\{fecha_carpeta_ayer}\GL_{fecha_archivo_ayer}_GLC.csv","a+")
        file.write(cadenaGLC)
        file.close()
    if cadenaPIO != "":
        file=open(f"{kspathdestino}\\{fecha_carpeta_ayer}\GL_{fecha_archivo_ayer}_PIO.csv","a+")
        file.write(cadenaPIO)
        file.close()
    if cadenaMID != "":
        file=open(f"{kspathdestino}\\{fecha_carpeta_ayer}\GL_{fecha_archivo_ayer}_MID.csv","a+")
        file.write(cadenaMID)
        file.close()
    if cadenaMNPR != "":
        file=open(f"{kspathdestino}\\{fecha_carpeta_ayer}\GL_{fecha_archivo_ayer}_MNPR.csv","a+")
        file.write(cadenaMNPR)
        file.close()
    if cadenaCHDR != "":
        file=open(f"{kspathdestino}\\{fecha_carpeta_ayer}\GL_{fecha_archivo_ayer}_CHDR.csv","a+")
        file.write(cadenaCHDR)
        file.close()
    if cadenaCDTL != "":
        file=open(f"{kspathdestino}\\{fecha_carpeta_ayer}\GL_{fecha_archivo_ayer}_CDTL.csv","a+")
        file.write(cadenaCDTL)
        file.close()
    if cadenaCMI != "":
        file=open(f"{kspathdestino}\\{fecha_carpeta_ayer}\GL_{fecha_archivo_ayer}_CMI.csv","a+")
        file.write(cadenaCMI)
        file.close()
    if cadenaCSVC != "":
        file=open(f"{kspathdestino}\\{fecha_carpeta_ayer}\GL_{fecha_archivo_ayer}_CSVC.csv","a+")
        file.write(cadenaCSVC)
        file.close()
    if cadenaCTND != "":
        file=open(f"{kspathdestino}\\{fecha_carpeta_ayer}\GL_{fecha_archivo_ayer}_CTND.csv","a+")
        file.write(cadenaCTND)
        file.close()
    if cadenaCDSC != "":
        file=open(f"{kspathdestino}\\{fecha_carpeta_ayer}\GL_{fecha_archivo_ayer}_CDSC.csv","a+")
        file.write(cadenaCDSC)
        file.close()
    if cadenaCOTD != "":
        file=open(f"{kspathdestino}\\{fecha_carpeta_ayer}\GL_{fecha_archivo_ayer}_COTD.csv","a+")
        file.write(cadenaCOTD)
        file.close()
    if cadenaCTAX != "":
        file=open(f"{kspathdestino}\\{fecha_carpeta_ayer}\GL_{fecha_archivo_ayer}_CTAX.csv","a+")
        file.write(cadenaCTAX)
        file.close()
    if cadenaCVAT != "":
        file=open(f"{kspathdestino}\\{fecha_carpeta_ayer}\GL_{fecha_archivo_ayer}_CVAT.csv","a+")
        file.write(cadenaCVAT)
        file.close()
    if cadenaFFD != "":
        file=open(f"{kspathdestino}\\{fecha_carpeta_ayer}\GL_{fecha_archivo_ayer}_FFD.csv","a+")
        file.write(cadenaFFD)
        file.close()
    if cadenaFFL != "":
        file=open(f"{kspathdestino}\\{fecha_carpeta_ayer}\GL_{fecha_archivo_ayer}_FFL.csv","a+")
        file.write(cadenaFFL)
        file.close()
    if cadenaCASH != "":
        file=open(f"{kspathdestino}\\{fecha_carpeta_ayer}\GL_{fecha_archivo_ayer}_CASH.csv","a+")
        file.write(cadenaCASH)
        file.close()
    if cadenaNONSLS != "":
        file=open(f"{kspathdestino}\\{fecha_carpeta_ayer}\GL_{fecha_archivo_ayer}_NONSLS.csv","a+")
        file.write(cadenaNONSLS)
        file.close()
    if cadenaCSHRSHFT != "":
        file=open(f"{kspathdestino}\\{fecha_carpeta_ayer}\GL_{fecha_archivo_ayer}_CSHRSHFT.csv","a+")
        file.write(cadenaCSHRSHFT)
        file.close()
    if cadenaCMB != "":
        file=open(f"{kspathdestino}\\{fecha_carpeta_ayer}\GL_{fecha_archivo_ayer}_CMB.csv","a+")
        file.write(cadenaCMB)
        file.close()
    if cadenaKDS != "":
        file=open(f"{kspathdestino}\\{fecha_carpeta_ayer}\GL_{fecha_archivo_ayer}_KDS.csv","a+")
        file.write(cadenaKDS)
        file.close()
    if cadenaOTD != "":
        file=open(f"{kspathdestino}\\{fecha_carpeta_ayer}\GL_{fecha_archivo_ayer}_OTD.csv","a+")
        file.write(cadenaOTD)
        file.close()
    if cadenaWST_GL != "":
        file=open(f"{kspathdestino}\\{fecha_carpeta_ayer}\GL_{fecha_archivo_ayer}_WST.csv","a+")
        file.write(cadenaWST_GL)
        file.close()

    if cadenaINV != "":
        file=open(f"{kspathdestino}\\{fecha_carpeta_ayer}\INV_{fecha_archivo_ayer}_INV.csv","a+")
        file.write(cadenaINV)
        file.close()
    if cadenaWST_I != "":
        file=open(f"{kspathdestino}\\{fecha_carpeta_ayer}\INV_{fecha_archivo_ayer}_WST.csv","a+")
        file.write(cadenaWST_I)
        file.close()
    if cadenaPO != "":
        file=open(f"{kspathdestino}\\{fecha_carpeta_ayer}\INV_{fecha_archivo_ayer}_PO.csv","a+")
        file.write(cadenaPO)
        file.close()
    if cadenaPODTL != "":
        file=open(f"{kspathdestino}\\{fecha_carpeta_ayer}\INV_{fecha_archivo_ayer}_PODTL.csv","a+")
        file.write(cadenaPODTL)
        file.close()
    if cadenaRCPT != "":
        file=open(f"{kspathdestino}\\{fecha_carpeta_ayer}\INV_{fecha_archivo_ayer}_RCPT.csv","a+")
        file.write(cadenaRCPT)
        file.close()
    if cadenaRCPTDTL != "":
        file=open(f"{kspathdestino}\\{fecha_carpeta_ayer}\INV_{fecha_archivo_ayer}_RCPTDTL.csv","a+")
        file.write(cadenaRCPTDTL)
        file.close()
    if cadenaXFER != "":
        file=open(f"{kspathdestino}\\{fecha_carpeta_ayer}\INV_{fecha_archivo_ayer}_XFER.csv","a+")
        file.write(cadenaXFER)
        file.close()
    if cadenaXFERDTL != "":
        file=open(f"{kspathdestino}\\{fecha_carpeta_ayer}\INV_{fecha_archivo_ayer}_XFERDTL.csv","a+")
        file.write(cadenaXFERDTL)
        file.close()
    if cadenaINVWST != "":
        file=open(f"{kspathdestino}\\{fecha_carpeta_ayer}\INV_{fecha_archivo_ayer}_INVWST.csv","a+")
    ...
    if cadenaLOC != "":
        file=open(f"{kspathdestino}\\{fecha_carpeta_actual}\LOC_{fecha_archivo_actual}_LOC.csv","a+")
        file.write(cadenaLOC)
        file.close()

    if cadenaPAY != "":
        file=open(f"{kspathdestino}\\{fecha_carpeta_ayer}\PAY_{fecha_archivo_ayer}_PAY.csv","a+")
        file.write(cadenaPAY)
        file.close()
    if cadenaTC != "":
        file=open(f"{kspathdestino}\\{fecha_carpeta_ayer}\PAY_{fecha_archivo_ayer}_TC.csv","a+")
        file.write(cadenaTC)
        file.close()
    if cadenaTCADJ != "":
        file=open(f"{kspathdestino}\\{fecha_carpeta_ayer}\PAY_{fecha_archivo_ayer}_TCADJ.csv","a+")
